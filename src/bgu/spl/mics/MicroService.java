...
public abstract class MicroService implements Runnable 
{
	...
	private ConcurrentHashMap<Class<? extends Event<?>>, Callback> callbacksByEvents = new ConcurrentHashMap<Class<? extends Event<?>>, Callback>();
	private ConcurrentHashMap<Class<? extends Broadcast>, Callback> callbacksByBroadcasts = new ConcurrentHashMap<Class<? extends Broadcast>, Callback>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) 
    {
    	...
    	callbacksByEvents.put(type, callback);
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback)
    {
    	...
    	callbacksByBroadcasts.put(type, callback);
        ...
        while (!terminated) 
        {
           try 
           {
        	   ...
        	   if(msg instanceof Broadcast) 
        	   {
        		   ...
        		   callbacksByBroadcasts.get(msg).call(msg);
        	   }
        	   else 
        	   {
        		   callbacksByEvents.get(msg).call(msg);
        	   }
		   } 
